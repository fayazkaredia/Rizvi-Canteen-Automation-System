<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="a_login.aspx.cs" Inherits="Canteen_Automation_System.a_login" %>
            ...
            <table width="70%">
                <tr>
                    <td colspan="2" align="center">
                        <asp:Label ID="Label1" runat="server" CssClass="heading" Text="Admin Login"></asp:Label>
                        <br />
                        <br />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                        <asp:Label ID="Label2" runat="server" CssClass="label" Text="Admin Id:"></asp:Label>
                        <br />
                        <br />
                    </td>
                    <td>
